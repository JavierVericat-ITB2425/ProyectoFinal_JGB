...
### **1.1 Activación de Event Listeners**
   ...
   ![Configuración de Event Listeners](Imagenes/img-001.png)
...
### **1.2 Persistencia de Eventos de Usuario y Administración**
   ...
   ![Configuración de Eventos de Usuario](Imagenes/img-002.png)
   *Configuración de la persistencia para eventos de usuario.*

   ![Configuración de Eventos de Administración](Imagenes/img-003.png)
...
#### **Comprobación**
   ...
   ![Listado de Eventos en Keycloak](Imagenes/img-004.png)
...
```
   ...
   ![Edición de Dashboard en Grafana](Imagenes/img-005.png)
...
#### **Comprobación**
   ...
   ![Panel OverView Final](Imagenes/img-006.png)
